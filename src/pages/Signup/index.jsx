    ...
    <div className="flex justify-center items-center min-h-screen bg-gray-100">
      <div className="flex bg-white shadow-md overflow-hidden rounded-lg w-[80%] max-w-5xl">
        ...
        <div className="w-1/2 p-8">
          <h1 className="text-2xl font-bold mb-6 text-gray-800">Get Started Now</h1>
          {/* Name Input */}
          <div className="mb-4">
          ...
          <p className="text-sm text-center text-gray-600">
            Have an account?{" "}
            <a href="/login" className="text-blue-500 font-semibold underline">
              Sign In
            </a>
          </p>
        </div>
        ...
        <div className="w-1/2 relative">
          ...
          <img
            src={logoImg}
            alt="Logo"
            className="absolute top-0.5 left-1/2 transform -translate-x-1/2 w-36"
          />
        </div>
      </div>
    </div>
