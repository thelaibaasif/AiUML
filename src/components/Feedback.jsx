  ...
  return (
    <div className="flex items-center justify-center min-h-screen bg-[#f6f8fa] px-4">
      <div className="bg-white shadow-2xl rounded-3xl p-8 max-w-lg w-full border border-slate-200 text-slate-700">
        ...
        <div className="mb-6">
          <h2 className="text-lg font-semibold text-slate-600 mb-2 text-center">
        ...
        <div className="flex justify-center gap-4">
          ...
          <button className="px-5 py-2 bg-red-700 hover:bg-red-800 text-white font-semibold border border-red-700 rounded-full transition duration-300">
            Cancel
          </button>
        </div>
      </div>
